...
library(luftdaten)
library(curl)
LD_download("/media/schmid/local/data/luftdaten/", start="2018-02-27", end="2018-02-28")
```
...
```{r}
library(luftdaten)
LD_sql2(start="2018/01/31", end="2018/02/28", source="/media/schmid/local/data/luftdaten/",dbname="db/2018-", sensortype="sds011",verbose=FALSE)
```
